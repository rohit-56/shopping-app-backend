...
public class UserServiceImpl implements IUserService {
    ...
    public UserEntityResponse createUser(UserEntityRequest userEntityRequest) {
        UserEntity userEntity = UserEntityMapper.fromUserEntityRequestToUserEntity.apply(userEntityRequest);

        //To Do -- Encrypt Password

        UserEntity savedUser = userEntityRepository.save(userEntity);
        UserEntityResponse userEntityResponse = UserEntityMapper.fromUserEntityToUserEntityResponse.apply(savedUser);
    ...
    public UserEntityResponse getUserById(Long userId) {
        ...
        if(userEntity.get()==null){
            ...
            UserEntityResponse userEntityResponse = UserEntityMapper.fromUserEntityToUserEntityResponse.apply(userEntity.get());
            return userEntityResponse;
        }
    }
    ...
    public boolean validateUser(LoginRequest loginRequest) {
        Optional<UserEntity> userEntity = userEntityRepository.findByUsername(loginRequest.getUsername());
