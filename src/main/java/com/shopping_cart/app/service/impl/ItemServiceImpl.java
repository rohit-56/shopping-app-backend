...
public class ItemServiceImpl implements IItemService {
    ...
    public ItemResponse getItemById(Long itemId) {
        ...
        if(itemEntity.isEmpty()){
            ...
            ItemResponse itemResponse=ItemEntityMapper.fromItemEntityToItemResponse.apply(itemEntity.get());
            return itemResponse;
        }
    }
    ...
    public List<ItemResponse> getItemsByCategory(String category) {
        ...
        List<ItemResponse> itemResponseList = itemEntityList.stream().map(ItemEntityMapper.fromItemEntityToItemResponse).toList();
